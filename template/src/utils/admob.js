...
import {ID_INTERSTITIAL, ID_BANNER, ID_REWARDED} from '../config';
...
export const AdsId = {
  android: {
    banner: __DEV__ ? TestIds.BANNER : ID_BANNER,
    interstitial: __DEV__ ? TestIds.INTERSTITIAL : ID_INTERSTITIAL,
    reward: __DEV__ ? TestIds.REWARDED : ID_REWARDED,
  },
  ios: {
